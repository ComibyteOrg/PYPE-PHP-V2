...
class Route
{
    ...
    {
        self::get('/auth/{provider}', [\App\Auth\SocialAuthController::class, 'redirectToProvider']);
        self::get('/auth/{provider}/callback', [\App\Auth\SocialAuthController::class, 'handleProviderCallback']);
    }
